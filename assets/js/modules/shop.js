            ...
            categoriesGrid.innerHTML = `
                <div class="col-span-full text-center py-20">
                    <div class="max-w-md mx-auto">
                        ...
                        <p class="text-gray-600 text-lg mb-2">No categories available at the moment</p>
                        <p class="text-gray-500 text-sm">Please check back later or contact support if this issue persists.</p>
                    </div>
                </div>
            `;
            return;
